...
export const RemoveButton = ({ product, phoneMatches, removeItem, classes}) => {
  return (
    <td>
...
export const ProductNumberSwitcher = ({phoneMatches, product, props, incrementItem, decrementItem}) => {
      ...
      <div className={classes.quantityContainer}>
        <div className={classes.quantityAndArrows}>
          ...
          <div className={classes.changeQuantity}>
            ...
            >
              <img className={classes.isToggled} src={Up} alt="up arrow" height={phoneMatches ? '10' : '20'} width={phoneMatches ? '10' : '20'} />
            </button>
            <button
              onClick={() => decrementItem(product.sku)}
              className={classes.button}
            >
              <img className={classes.isToggled} src={Down} eight={phoneMatches ? '10' : '20'} alt="down arrow" width={phoneMatches ? '10' : '20'} />
            </button>
          </div>
        </div>
...
export const RemoveItemButton = ({phoneMatches,product, classes, removeItem}) => {
    return (
      <td>
        {!phoneMatches && (
          <button
            ...
            className={classes.button}
          >
            <img src={Close} height="20" className={classes.isToggled} alt="close icon"/>
          </button>
        )}
      </td>
    )
...
let props
  ...
  const cellProps = {product, phoneMatches, classes, incrementItem, decrementItem, removeItem, props}
  return (
    <tr>
